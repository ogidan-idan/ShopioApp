    ...
    return (
        <SafeAreaView style={style.container}>
            <View style={style.searchRow}>
                ...
                <TouchableOpacity onPress={() => goTo("Notifications")}>
            ...
            <View>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={style.categoryScroll}>
                    <TouchableOpacity onPress={() => goTo("NotAvil")} style={style.bottonicon}>
            ...
            <View style={style.productContainer}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={style.productScroll}>
                    <View style={style.productview}>
                        <TouchableOpacity onPress={() => goTo("Product1")} style={style.bottonicon}>
                        ...
                        <TouchableOpacity onPress={() => goTo("Product2")} style={style.bottonicon}>
                        ...
                        <TouchableOpacity onPress={() => goTo("Product3")} style={style.bottonicon}>
                        ...
                        <TouchableOpacity onPress={() => goTo("Product4")} style={style.bottonicon}>
